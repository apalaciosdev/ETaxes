...
const { productsGet, productGet, productsPost, productsPut, productsDelete, productExists, userProducts, checkUserHaveProduct, createOffer } = require('../controllers/products')
