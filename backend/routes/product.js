...
const { productsGet, productGet, productsPost, productsPut, productsDelete, productExists, getProductsCount, userProducts, checkUserHaveProduct, createOffer } = require('../controllers/products')
